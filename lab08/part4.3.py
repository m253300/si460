...
class Scene:
    ...
    def __init__(self, width=800, height=600, caption="Would you like to play a game?", resizable=False):
        ...
        def on_draw():
            ...
            glTranslatef(-7.0, 0.0, -15.0)   # Move the Cube into the Frustum
            WireCube(5.0) # Draw a 5x5x5 wire cube

            glTranslatef(14.0, 0.0, 0.0)   # Move the Cube into the Frustum
            WireCube(5.0) # Draw a 5x5x5 wire cube

            glTranslatef(-7.0, -7.0, 0.0)   # Move the Cube into the Frustum
            WireCube(5.0) # Draw a 5x5x5 wire cube

            glTranslatef(0.0, 14.0, 0.0)   # Move the Cube into the Frustum
            WireCube(5.0) # Draw a 5x5x5 wire cube
