...
# I USED CHATGPT TO GET AN IDEA OF HOW TO DO THIS MUCH EASIER NOW THAT I HAVE THE OTHER FUNCTION CREATED, MY INPUT AND THE OUTPUT ARE INCLUDED IN ANOTHER FILE FOR THE PART 4 SUBMISSION
def loadAllImages(filepath="mylevel/sprites"):
    ...
    for file in files:
        all_sprites[file] = loadImages(f'{filepath}/{file}')
