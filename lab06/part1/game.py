...
class Game:
    ...
    def __init__(self, width=800, height=600, caption="Would you like to play a game?", players=[], resizable=False):
        ...
        # load the islands pieces
        self.islandL = pyglet.resource.image("mylevel/tiles/hl.png")
        self.islandM = pyglet.resource.image("mylevel/tiles/hm.png")
        self.islandR = pyglet.resource.image("mylevel/tiles/hr.png")
        self.islandL_x = 170
        self.island_y = 165
        self.islandM_x = self.islandL_x + 128
        self.islandR_x = self.islandM_x + 128
        ...
        def on_draw():
            ...
            # Draw the island
            self.islandL.blit(self.islandL_x, self.island_y)
            self.islandM.blit(self.islandM_x, self.island_y)
            self.islandR.blit(self.islandR_x, self.island_y)
