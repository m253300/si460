...
if __name__ == '__main__':
    ...
    sprite = buildSprite(imagesTest, character="enemy-1", mode="Run", facing="Right", animationSpeed=0.05, animationScale=0.15, animationLoop=True, animationX=100, animationY=100)
